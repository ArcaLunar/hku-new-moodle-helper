...
GM_setValue("selectedCoursesList", [
    { courseId: "113380", teacher: "test1", summary: "test1" },
    { courseId: "104467", teacher: "test2", summary: "test2" },
  ]);
  ...
  (function () {
    ...
    function removeFromSem(currentCourseId, selectedCoursesList) {
      ...
      GM_setValue("selectedCoursesList", filteredList);
    }
    ...
    function addToSemester(currentCourseId, selectedCoursesList) {
      ...
      GM_setValue("selectedCoursesList", selectedCoursesList);
    }
  })();
